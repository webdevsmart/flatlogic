...
import {requestLogin, receiveLogin, loginError} from '../../../actions/user';
                ...
                {(loginMutation, { data }) => (
                  <Form className="mt" onSubmit={ 
                    (e) => {
                      ...
                      loginMutation({
                        variables: {
                          data: {email: this.state.login, password: this.state.password}
                        }
                      })
                      .then(res => res.data)
                      .then(data => {
                      ...
                      .catch((err) => {
                        this.props.dispatch(loginError(err.message));
                      })
                    }
                  }>
                    ...
                    <div className="text-center">
                      ...
                      <Link to="/signup" className="fs-lg fw-roboto-medium">Don't Have an Account? Sign Up Now</Link>
                    </div>
                  </Form>
                )}
              </Mutation>
